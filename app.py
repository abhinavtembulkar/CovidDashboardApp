...
def main():
    ...
    if st.checkbox("--About Me--"):
        ...
        st.write(''' ***Built by ABHINAV TEMBULKAR***  ''') 
        st.write(''' ***Linkedin*** : https://www.linkedin.com/in/abhinav-tembulkar-12b665150/ ''')
        st.write(''' ***Github*** : https://github.com/abhinavtembulkar/ ''')
